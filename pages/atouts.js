      ...
      <Section delay={0.2}>
        <Container>
          <Flex gap={4} align="start">
            ...
            />
            <Paragraph>
              Une convention de services motivante pour toutes les parties et
              qui tend essentiellement à la satisfaction du client/assuré.
            </Paragraph>
          </Flex>
          <Divider bg="black" mt={18} mb={18} />
        </Container>
        ...
        <Container>
          <Flex gap={4}>
            ...
            <Paragraph>
              ...
              partenaires. Les réparateurs obtiennent une réponse immédiate à
              toute question concernant les dossiers et les règlements, en cours
              ou déjà effectués.
            </Paragraph>
          </Flex>
          <Divider bg="black" mt={18} mb={18} />
