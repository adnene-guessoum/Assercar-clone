          ...
          <List>
            <ListItem>
              <Flex gap={4}>
                ...
                />
                <Paragraph>
                  Une convention de services motivante pour toutes les parties
                  et qui tend essentiellement à la satisfaction du
                  client/assuré.
                </Paragraph>
              </Flex>
            </ListItem>
            ...
            <ListItem>
              <Flex gap={4}>
                ...
                <Paragraph>
                  ...
                  de géolocalisation pour une recherche rapide des réparateurs
                  proches du client/assuré.
                </Paragraph>
              </Flex>
            </ListItem>
            ...
            <ListItem>
              <Flex gap={4}>
                ...
                <Paragraph>
                  ...
                  liaisons informatiques permanentes avec nos clients et
                  partenaires. Les réparateurs obtiennent une réponse immédiate
                  à toute question concernant les dossiers et les règlements, en
                  cours ou déjà effectués.
                </Paragraph>
              </Flex>
            </ListItem>
            ...
            <ListItem>
              <Flex gap={4}>
                ...
                />
                <Paragraph>
                  La fourniture à nos clients de statistiques hebdomadaires (dès
                  le lundi suivant) avec une synthèse de l&apos;activité et les
                  nombres de dossiers et taux d&apos;orientation par région, par
                  entité et même par gestionnaire sinistre. Ces statistiques
                  constituent un véritable outil de management et de motivation
            ...
            <ListItem>
              <Flex gap={4}>
                ...
                />
                <Paragraph>
                  Un rapport mensuel d&apos;activité pour chaque client/assureur
                  (au plus tard le 3ème jour ouvrable du mois suivant) avec la
                  situation du réseau et les résultats chiffrés de
                  l&apos;activité.
                </Paragraph>
              </Flex>
            </ListItem>
