...
const PageAtouts = () => {
  return (
    <Flex direction="column" w="75%" ml="280px">
      <Container>
        <Image src="/images/convention/titre_convention.gif" alt="bannière convention" />
      ...
      <Section delay={0.1}>
        <Flex gap={3} align="center">
          ...
          />
          <Titre>
		La convention de services est signée par le réparateur et par ASSERCAR, elle engage également les assureurs cités qui s&apos;efforcent d&apos;orienter leurs clients/assurés vers les réparateurs signataires. Chaque partie retire des avantages de la convention :
		</Titre>
        </Flex>
        <Divider bg="black" mt={18} mb={18} />
      </Section>
